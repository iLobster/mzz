...
INSERT INTO `comments_comments` (`id`, `obj_id`, `text`, `author`, `time`, `folder_id`) VALUES 
  ...
  (16,104,'qwe',2,1163642189,9),
  (17,105,'zzzzzzzzz',2,1163642193,9),
  (18,106,'фффффффффаау',2,1163642197,9),
  (19,107,'hhhhh',2,1163649651,7),
  (20,108,'рррррррррр',2,1163651468,7);
...
INSERT INTO `sys_access` (`id`, `action_id`, `class_section_id`, `obj_id`, `uid`, `gid`, `allow`, `deny`) VALUES 
  ...
  (588,2,3,13,NULL,2,1,0),
  (587,12,3,13,NULL,2,1,0),
  (586,1,3,13,NULL,2,1,0),
  (585,5,3,13,NULL,2,1,0),
  (584,11,3,13,NULL,2,1,0),
  (583,10,3,13,NULL,2,1,0),
  ...
  (716,2,3,12,NULL,2,1,0),
  (715,12,3,12,NULL,2,0,1),
  (714,1,3,12,NULL,2,0,1),
  (713,5,3,12,NULL,2,0,1),
  (712,11,3,12,NULL,2,0,1),
  (711,10,3,12,NULL,2,0,1),
  ...
  (912,9,10,104,2,NULL,1,0),
  (911,2,10,104,2,NULL,1,0),
  (910,1,10,104,2,NULL,1,0),
  (913,1,10,105,2,NULL,1,0),
  (914,2,10,105,2,NULL,1,0),
  (915,9,10,105,2,NULL,1,0),
  (916,1,10,106,2,NULL,1,0),
  (917,2,10,106,2,NULL,1,0),
  (918,9,10,106,2,NULL,1,0),
