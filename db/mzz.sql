...
INSERT INTO `sys_access` (`id`, `action_id`, `class_section_id`, `obj_id`, `uid`, `gid`, `allow`, `deny`) VALUES 
  ...
  (1623,9,2,276,NULL,1,0,0),
  (1624,8,2,276,NULL,1,0,0),
  (1625,7,2,276,NULL,1,0,0),
  (1626,6,2,276,NULL,1,0,0),
  (1627,5,2,276,NULL,1,1,0),
  (1628,4,2,276,NULL,1,0,0),
  (1629,4,2,276,NULL,2,1,0),
  (1630,5,2,276,NULL,2,1,0),
  (1631,6,2,276,NULL,2,1,0),
  (1632,7,2,276,NULL,2,0,0),
  (1633,8,2,276,NULL,2,0,0),
  (1634,9,2,276,NULL,2,0,0),
  (1635,9,2,276,2,NULL,1,0),
  (1636,6,2,276,2,NULL,1,0),
  (1637,5,2,276,2,NULL,1,0),
  (1638,4,2,276,2,NULL,1,0),
  (1639,8,2,276,2,NULL,1,0),
  (1640,7,2,276,2,NULL,1,0),
  (1641,9,2,276,2,NULL,1,0),
  (1642,8,2,276,2,NULL,1,0),
  (1643,7,2,276,2,NULL,1,0),
  (1644,6,2,276,2,NULL,1,0),
  (1645,5,2,276,2,NULL,1,0),
  (1646,4,2,276,2,NULL,1,0),
  (1647,9,2,277,NULL,1,0,0),
  (1648,8,2,277,NULL,1,0,0),
  (1649,7,2,277,NULL,1,0,0),
  (1650,6,2,277,NULL,1,0,0),
  (1651,5,2,277,NULL,1,1,0),
  (1652,4,2,277,NULL,1,0,0),
  (1653,4,2,277,NULL,2,1,0),
  (1654,5,2,277,NULL,2,1,0),
  (1655,6,2,277,NULL,2,1,0),
  (1656,7,2,277,NULL,2,0,0),
  (1657,8,2,277,NULL,2,0,0),
  (1658,9,2,277,NULL,2,0,0),
  (1659,9,2,277,2,NULL,1,0),
  (1660,6,2,277,2,NULL,1,0),
  (1661,5,2,277,2,NULL,1,0),
  (1662,4,2,277,2,NULL,1,0),
  (1663,8,2,277,2,NULL,1,0),
  (1664,7,2,277,2,NULL,1,0),
  (1665,9,2,277,2,NULL,1,0),
  (1666,8,2,277,2,NULL,1,0),
  (1667,7,2,277,2,NULL,1,0),
  (1668,6,2,277,2,NULL,1,0),
  (1669,5,2,277,2,NULL,1,0),
  (1670,4,2,277,2,NULL,1,0),
  (1671,9,2,278,NULL,1,0,0),
  (1672,8,2,278,NULL,1,0,0),
  (1673,7,2,278,NULL,1,0,0),
  (1674,6,2,278,NULL,1,0,0),
  (1675,5,2,278,NULL,1,1,0),
  (1676,4,2,278,NULL,1,0,0),
  (1677,4,2,278,NULL,2,1,0),
  (1678,5,2,278,NULL,2,1,0),
  (1679,6,2,278,NULL,2,1,0),
  (1680,7,2,278,NULL,2,0,0),
  (1681,8,2,278,NULL,2,0,0),
  (1682,9,2,278,NULL,2,0,0),
  (1683,9,2,278,2,NULL,1,0),
  (1684,6,2,278,2,NULL,1,0),
  (1685,5,2,278,2,NULL,1,0),
  (1686,4,2,278,2,NULL,1,0),
  (1687,8,2,278,2,NULL,1,0),
  (1688,7,2,278,2,NULL,1,0),
  (1689,9,2,278,2,NULL,1,0),
  (1690,8,2,278,2,NULL,1,0),
