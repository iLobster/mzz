...
INSERT INTO `user_user` (`id`, `obj_id`, `login`, `password`, `created`, `confirmed`, `last_login`) VALUES 
  (1,12,'guest','',NULL,NULL,1189996703),
  (2,13,'admin','098f6bcd4621d373cade4e832627b4f6',NULL,NULL,1190000092),
  (3,472,'pedro','098f6bcd4621d373cade4e832627b4f6',1188187851,NULL,1189980238);
...
INSERT INTO `user_userOnline` (`id`, `user_id`, `session`, `last_activity`, `url`, `ip`) VALUES 
  (172,3,'b9b1070a628cae8b2399230be5bd174c',1190001055,'http://mzz/forum/2/list','127.0.0.1'),
  (169,2,'22dee5eabfc7350e68857a5fdb2a65fe',1190001074,'http://mzz/forum/new','127.0.0.1');
