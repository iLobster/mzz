...
INSERT INTO `catalogue_catalogue_data` (`id`, `property_type`, `text`, `char`, `int`, `date`, `float`) VALUES 
  ...
  (8,28,NULL,'GSM 900/1800/1900',NULL,NULL,NULL),
  (8,29,NULL,'91 г.',NULL,NULL,NULL),
  (8,30,NULL,'106.4 x 43.6 x 11.7',NULL,NULL,NULL),
  (9,28,NULL,'GSM 850/900/1800/1900',NULL,NULL,NULL),
...
CREATE TABLE `sys_obj_id` (
  `id` int(11) unsigned NOT NULL auto_increment,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=506 DEFAULT CHARSET=cp1251;
...
INSERT INTO `user_user` (`id`, `obj_id`, `login`, `password`) VALUES 
  ...
  (3,472,'pedro','098f6bcd4621d373cade4e832627b4f6');
