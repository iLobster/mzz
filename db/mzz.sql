...
INSERT INTO `page_page_lang` (`id`, `lang_id`, `title`, `content`, `keywords`, `description`) VALUES 
  (1,1,'Добро пожаловать!!','Добро пожаловать в mzz v.0.3<br /><br />\n\nМы рады представить вам новую версию нашего фреймворка. За время, прошедшее с момента выпуска версии 0.2.1, было переписано большое количество старого, иногда рудиментарного, кода.<br />\nВ этой версии основной акцент был сделан на стабильность.<br />\nИз изменений особо хотелось бы выделить переписанный с нуля ORM. Теперь он более гибкий и немного более быстрый. Также, теперь mzz обзавёлся двумя политиками обработки прав пользователей: acl_simple и acl_ext. Упрощённый оперирует классами объектов, расширенный - так же как и раньше, конкретными объектами.<br />\nВ этот релиз были включены переписанные с учетом нововведений самые необходимые из предыдущих модулей: новости, страницы, файловый менеджер, комментарии, меню. А также системные модули: ACL, users, бла…, бла… Некоторые модули были перенесены в нестабильную ветвь разработки (/branches) и будут доступны в следующих релизах.<br />\nБыла основательно переработана документация. Дописаны новые главы. Устаревшие - переписаны или удалены.\nДа, мы ещё далеки от совершенства. Но, мне кажется, уже сейчас мы достойны частички вашего внимания :-)<br /><br />\n\nСпасибо за внимание. \nС уважением, Курносов Иван (zerkms).<br /><br />\n\nПо всем вопросам касаемо mzz вы можете всё так же обращаться в наш форум, либо irc://mzz@irc.rusnet.ru либо ко мне лично по любому из доступных вам способов связи.','',''),
...
AUTO_INCREMENT=133 ROW_FORMAT=FIXED CHARACTER SET 'utf8' COLLATE 'utf8_general_ci';
