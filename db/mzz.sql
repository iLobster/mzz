...
CREATE TABLE `menu_menuItem` (
  ...
  `obj_id` int(10) unsigned default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=cp1251 PACK_KEYS=0;
...
) ENGINE=MyISAM AUTO_INCREMENT=5011 DEFAULT CHARSET=cp1251;
...
) ENGINE=MyISAM AUTO_INCREMENT=256 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `sys_obj_id` (
  `id` int(11) unsigned NOT NULL auto_increment,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1244 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `user_userAuth` (
  ...
  `time` int(11) unsigned default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=cp1251;
...
) ENGINE=MyISAM AUTO_INCREMENT=210 DEFAULT CHARSET=cp1251;
