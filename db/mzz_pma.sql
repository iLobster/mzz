...
-- 
-- Хост: localhost
-- Время создания: Авг 01 2007 г., 15:29
...
INSERT INTO `catalogue_catalogue_properties` VALUES (31, 'test1', 'Динамический селект', 7, 'a:7:{s:6:"module";s:4:"user";s:2:"do";s:4:"user";s:7:"section";s:4:"user";s:12:"searchMethod";s:9:"searchAll";s:13:"extractMethod";s:8:"getLogin";s:6:"params";s:0:"";s:11:"nullElement";b:1;}');
INSERT INTO `catalogue_catalogue_properties` VALUES (32, 'img', 'Изображение', 8, 'a:5:{s:6:"module";s:7:"gallery";s:2:"do";s:5:"photo";s:7:"section";s:7:"gallery";s:12:"searchMethod";s:9:"searchAll";s:6:"params";s:0:"";}');

-- --------------------------------------------------------

-- 
-- Структура таблицы `catalogue_catalogue_properties_types`
-- 
...
-- 
-- Дамп данных таблицы `catalogue_catalogue_properties_types`
-- 
...
INSERT INTO `catalogue_catalogue_properties_types` VALUES (3, 'int', 'Целое');
INSERT INTO `catalogue_catalogue_properties_types` VALUES (4, 'text', 'Текст');
INSERT INTO `catalogue_catalogue_properties_types` VALUES (5, 'select', 'Список');
INSERT INTO `catalogue_catalogue_properties_types` VALUES (6, 'datetime', 'Дата и время');
INSERT INTO `catalogue_catalogue_properties_types` VALUES (7, 'dynamicselect', 'Динамический select');
...
INSERT INTO `fileManager_file` VALUES (1, '161577520fa51c296ac29682a28ab915', '1.jpg', 'jpg', 41037, 16, 1, '', 5, 611);
INSERT INTO `fileManager_file` VALUES (3, '80028e6d2a5175bf1d263f4e96c3a67f', '1.jpg', 'jpg', 1553, 65, 1, '', 6, 623);
...
INSERT INTO `fileManager_folder` VALUES (6, 'thumbnails', 'Превью', 6, 'root/gallery/thumbnails', 534, 0, '');
...
INSERT INTO `fileManager_folder_tree` VALUES (1, 1, 6, 1);
INSERT INTO `fileManager_folder_tree` VALUES (6, 3, 4, 3);
INSERT INTO `fileManager_folder_tree` VALUES (5, 2, 5, 2);
...
INSERT INTO `gallery_album` VALUES (2, 1, 'gsdf', 0, 1183979981, 0, 777);
...
INSERT INTO `gallery_photo` VALUES (1, 1, 'девка', NULL, NULL, 612);
...
INSERT INTO `menu_menuItem` VALUES (6, 0, 2, 5, 'Панель управления', 6, 666);
INSERT INTO `menu_menuItem` VALUES (7, 0, 2, 5, 'Сообщения', 7, 815);

-- --------------------------------------------------------

-- 
-- Структура таблицы `menu_menuItem_data`
-- 
...
-- 
-- Дамп данных таблицы `menu_menuItem_data`
-- 
...
-- 
-- Структура таблицы `menu_menuItem_properties`
-- 
...
-- 
-- Дамп данных таблицы `menu_menuItem_properties`
-- 
...
-- 
-- Структура таблицы `menu_menuItem_properties_types`
-- 
...
-- 
-- Дамп данных таблицы `menu_menuItem_properties_types`
-- 
...
-- 
-- Структура таблицы `menu_menuItem_types`
-- 
...
-- 
-- Дамп данных таблицы `menu_menuItem_types`
-- 
...
-- 
-- Структура таблицы `menu_menuItem_types_props`
-- 
...
-- 
-- Дамп данных таблицы `menu_menuItem_types_props`
-- 
...
-- 
-- Структура таблицы `message_message`
-- 
...
-- 
-- Дамп данных таблицы `message_message`
-- 
...
-- 
-- Структура таблицы `message_messageCategory`
-- 
...
-- 
-- Дамп данных таблицы `message_messageCategory`
-- 
...
INSERT INTO `sys_access_registry` VALUES (534, 15);
...
INSERT INTO `sys_access_registry` VALUES (623, 14);
INSERT INTO `sys_access_registry` VALUES (842, 25);
INSERT INTO `sys_access_registry` VALUES (777, 18);
...
INSERT INTO `sys_access_registry` VALUES (827, 26);
...
INSERT INTO `sys_access_registry` VALUES (855, 25);
INSERT INTO `sys_access_registry` VALUES (853, 24);
INSERT INTO `sys_access_registry` VALUES (854, 26);
INSERT INTO `sys_access_registry` VALUES (856, 26);
...
-- 
-- Структура таблицы `sys_cfg_titles`
-- 
...
-- 
-- Дамп данных таблицы `sys_cfg_titles`
-- 
...
-- 
-- Структура таблицы `sys_cfg_vars`
-- 
...
-- 
-- Дамп данных таблицы `sys_cfg_vars`
-- 
...
INSERT INTO `sys_classes_actions` VALUES (166, 24, 67);
...
INSERT INTO `sys_classes_actions` VALUES (198, 34, 75);
...
INSERT INTO `user_user` VALUES (1, 12, 'guest', '', NULL, NULL);
INSERT INTO `user_user` VALUES (2, 13, 'admin', '098f6bcd4621d373cade4e832627b4f6', NULL, NULL);
INSERT INTO `user_user` VALUES (3, 472, 'pedro', '098f6bcd4621d373cade4e832627b4f6', NULL, NULL);
...
INSERT INTO `user_userAuth` VALUES (26, 2, '127.0.0.1', 'e43de89500fe5c144b5a4687c80cefa9', 253, 1173239786);
INSERT INTO `user_userAuth` VALUES (27, 2, '127.0.0.1', 'ccc906aca21b95a2e8825f6533632de5', 259, 1173277691);
INSERT INTO `user_userAuth` VALUES (28, 2, '127.0.0.1', 'ab6db17706e797855c40ba766f8ee3fc', 260, 1173523868);
INSERT INTO `user_userAuth` VALUES (29, 2, '127.0.0.1', '64e5e933282a5f410d87265186533fe4', 262, 1173738059);
INSERT INTO `user_userAuth` VALUES (31, 2, '127.0.0.1', '86db01de276d43e124a8f90698a47535', 286, 1174513056);
INSERT INTO `user_userAuth` VALUES (32, 2, '127.0.0.1', '38c02192a4890c38332d953ea4eaf6d8', 476, 1174653915);
INSERT INTO `user_userAuth` VALUES (33, 2, '127.0.0.1', '8539a118934eb12959125b4a42c2cf20', 494, 1175426933);
INSERT INTO `user_userAuth` VALUES (36, 2, '127.0.0.1', '19269e37d22baa4c020b3c4b3732c9ea', 498, 1175870749);
INSERT INTO `user_userAuth` VALUES (38, 2, '127.0.0.1', 'd6090ce8c9813fad79e3da7eae307a81', 507, 1177501534);
INSERT INTO `user_userAuth` VALUES (41, 2, '127.0.0.1', '30a14bf7cf464e1954409b121b7b0f81', 529, 1178274095);
INSERT INTO `user_userAuth` VALUES (40, 2, '127.0.0.1', '8c54ec4684e05d0d7b1c77af2c1c548b', 524, 1177993805);
INSERT INTO `user_userAuth` VALUES (42, 2, '127.0.0.1', 'a47cd179dacb2cbc2fcbf3e243d12ddb', 538, 1179236686);
INSERT INTO `user_userAuth` VALUES (43, 2, '127.0.0.1', 'b2511bfd1d2906995fe96f68984c7181', 541, 1179495030);
INSERT INTO `user_userAuth` VALUES (44, 2, '127.0.0.1', 'a46540554cada38f1d48bd0832078e5f', 567, 1179718723);
INSERT INTO `user_userAuth` VALUES (45, 2, '127.0.0.1', 'cba27dedbe67f747ae71e793c7f815e7', 615, 1179777463);
INSERT INTO `user_userAuth` VALUES (46, 2, '127.0.0.1', 'aeec5af86d3bac1a76a24f28ef32b7ec', 619, 1179993941);
INSERT INTO `user_userAuth` VALUES (47, 2, '127.0.0.1', 'c6de5dc93546987d91e834e88dd1e321', 634, 1181822827);
INSERT INTO `user_userAuth` VALUES (48, 2, '127.0.0.1', '7f825cd5ac7360ed49bc536d0e9ed9d3', 654, 1182045769);
INSERT INTO `user_userAuth` VALUES (68, 2, '127.0.0.1', '659714e5e2556811f0fae16ad79c79c9', 759, 1183614529);
INSERT INTO `user_userAuth` VALUES (69, 2, '127.0.0.1', 'af59f1b8afe2820814baf343a7283055', 770, 1183816243);
...
INSERT INTO `user_userOnline` VALUES (91, 2, '5a6bd256ea619e1196e305fcc872ca72', '2007-08-01 16:28:22', 853, 'http://mzz/page', '127.0.0.1');

-- --------------------------------------------------------

-- 
-- Структура таблицы `voting_answer`
-- 
...
-- 
-- Дамп данных таблицы `voting_answer`
-- 

INSERT INTO `voting_answer` VALUES (2, 'Нет', 0, 1, 799);
INSERT INTO `voting_answer` VALUES (5, 'Да', 0, 1, 823);
INSERT INTO `voting_answer` VALUES (9, 'еуые', 1, 1, 827);
INSERT INTO `voting_answer` VALUES (10, 'Да', 0, 2, 854);
INSERT INTO `voting_answer` VALUES (11, 'Нет', 0, 2, 856);

-- --------------------------------------------------------

-- 
-- Структура таблицы `voting_question`
-- 
...
-- 
-- Дамп данных таблицы `voting_question`
-- 

INSERT INTO `voting_question` VALUES (1, 'Вы верите в розового жирафика?', 1, 796);
INSERT INTO `voting_question` VALUES (2, 'Ая?', 1, 855);

-- --------------------------------------------------------

-- 
-- Структура таблицы `voting_vote`
-- 
...
-- 
-- Дамп данных таблицы `voting_vote`
-- 
...
-- 
-- Структура таблицы `voting_voteCategory`
-- 
...
-- 
-- Дамп данных таблицы `voting_voteCategory`
-- 
