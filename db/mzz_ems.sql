...
INSERT INTO `catalogue_catalogue_data` (`id`, `property_type`, `text`, `char`, `int`, `date`, `float`) VALUES 
  ...
  (6,18,NULL,'asdf',NULL,NULL,NULL),
  (6,6,NULL,'asdf',NULL,NULL,NULL),
  (6,5,NULL,'asdf',NULL,NULL,NULL),
  (6,4,NULL,'sdfg',NULL,NULL,NULL),
  (7,17,NULL,'sdfsdf',NULL,NULL,NULL),
  (7,12,NULL,NULL,123123,NULL,NULL),
  (7,3,NULL,'sdf',NULL,NULL,NULL),
  (8,4,NULL,'asdf',NULL,NULL,NULL),
  (8,5,NULL,'asdf',NULL,NULL,NULL),
  (8,6,NULL,'asdf',NULL,NULL,NULL),
  (8,18,NULL,'asdf',NULL,NULL,NULL),
  (10,23,NULL,NULL,NULL,NULL,123.001);
