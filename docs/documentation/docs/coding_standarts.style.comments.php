<p>Все блоки комментариев должны быть совместимы с форматом phpDocumentor. Для дополнительно информации смотрите: <a href="http://phpdoc.org/">http://phpdoc.org/</a></p>
