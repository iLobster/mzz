<p>Определимся со структурой БД. Для таблицы с комментариями нам нужны следующие поля:</p>
<ul>
...
<</code>>
<<note>>Как вы можете заметить - в этой схеме мы ещё не учли отношения с таблицами пользователей и commentsFolder. Это будет сделано чуть позднее.<</note>>
<p>Для сущности commentsFolder таблица БД будет следующей:</p>
<ul>
...
<</code>>
<p>И эту структуру также опишем в файле commentsFolder.map.ini:</p>
<<code>>
    [id]<br />
    accessor = "getId"<br />
    mutator = "setId"<br />
