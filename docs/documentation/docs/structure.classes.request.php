<p>  GET, POST, COOKIE и к параметрам в пути необходимо обращатьс€ через класс <code>httpRequest</code>. ¬ приложении существует только один объект этого класса, который может быть получен из Toolkit следующим образом:</p>
<<code php>>
...
им€ внешней переменной, тип (к которому будет приведено значение) и источник данных. ѕо умолчанию тип - <code>mixed</code>, источник данных - <code>SC_PATH</code>.</p>
<!-- code 1 -->
<p>ƒоступные типы:</p>
