...
<p>
Теперь нам необходимо создать модуль блог, структуру его директорий и, собственно, сами модели. Для этих целей во MZZ реализован web-интерфейс для управления модулями. Зайти в него можно по адресу <tt>http://MZZ.blog/admin/devToolbar</tt> используя стандартый логин и пароль (<tt>admin</tt> / <tt>test</tt>). В дальнейшем под словом devToolbar мы будем подразумевать именно этот интерфейс.
</p>
