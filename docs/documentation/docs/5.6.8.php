...
<p>Последний аргумент указывает - кто будет владельцем только что созданного commentsFolder'а. Затем попытаемся открыть какую-либо новость. Урл для определённой новости будет выглядеть приблизительно так:</p>
...
<!-- code 13 -->
<!-- code 14 -->
<p>Как видите - заодно мы вывели jip для commentsFolder. Теперь по обновлению страницы вы должны увидеть список комментариев. Однако, как видно из шаблона и непосредственно в списке комментариев, вместо логина автора комментария у нас выводится его id. Свяжем соотношением 1:1 комментарий и пользователей, а также комментарий и "папку с комментариями". Comments.map.ini и шаблон соответственно изменятся:</p>
<!-- code 15 -->
<!-- code 16 -->
