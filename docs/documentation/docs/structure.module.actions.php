...
<table class="listTable" style="width: 85%;">
    ...
    <tbody>
        <tr>
            <td>main</td>
            <td>
                <p>Main-шаблон для действия. Может принимать следующие значения:</p>
                <ul>
                ...
                <p>Если данный парамер не задан, то по-умолчанию будет использоваться <strong>active.main.tpl</strong> шаблон</p>
            </td>
            <td>string</td>
        </tr>
        <tr>
