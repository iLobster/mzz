<p>Конфигурация mzz начинается с файла <code>config.php</code> в папке configs проекта. При необходимости можно изменить необходимые опции.</p>
<p>Описание опций:</p>
...
<div class="options_desc">Имя пользователя для доступа к БД, указанной в DSN</div>
