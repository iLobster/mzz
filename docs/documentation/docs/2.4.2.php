<p>Маршрутизация (Routing) - это процесс разделение запрошенного URL на ассоциативный массив с помощью правила (route). Доступ к этому массиву возможен через объект <code>httpRequest</code> с третьим аргументом <code>SC_PATH</code>.</p>
