...
<table width="100%" border="0" cellpadding="5" cellspacing="0" align="center">
    ...
    <tr>
        <td>&nbsp;</td>
        <td style="font-size: 80%;"><a href="javascript: jipWindow.toggleEditorById(this, 'contentArea');" style="text-decoration: none; border-bottom: 1px dashed #aaa;">Включить WYSIWYG-редактор</a></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
