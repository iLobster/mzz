...
<table border="0" width="100%" cellpadding="0" cellspacing="1">
    ...
    {/foreach}
    <tr>
        <td align="center"><a href="{url section=user action=groupCreate}" onClick="openWin('{url section=user action=groupCreate}', 'group_create', 500,400); return false;"><img src="/templates/images/add.png" width="16" height="16" border="0" /></a></td>
