...
<table border="0" width="99%" cellpadding="4" cellspacing="0" class="list">
    ...
    {/foreach}
    <tr>
        <td align="center"><a href="{url section=user action=create}" onClick="showJip('{url section=user action=create}'); return false;"><img src="{url section="" params="templates/images/add.gif"}" width="16" height="16" /></a></td>
