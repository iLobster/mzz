		...
		if (tinyMCE.settings.strict_loading_mode)
			this.pendingFiles[this.pendingFiles.length] = url;
                	...
                	var scr = document.createElement('script');
                        if (!window.opera) { scr.onreadystatechange = TinyMCE_Engine.prototype.onLoadScript; }
			scr.onload = TinyMCE_Engine.prototype.onLoadScript;
			scr.onerror = TinyMCE_Engine.prototype.onLoadScript;
