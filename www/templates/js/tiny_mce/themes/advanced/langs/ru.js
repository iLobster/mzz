...
invalid_data : 'Ошибка: введены неправильные значения, они отмечены красным цветом.',
more_colors : 'Выбрать цвет...',
color_picker_tab : 'Выбор',
color_picker : 'Выбор цвета',
web_colors_tab : 'Web safe',
web_colors : 'Web safe цвета',
named_colors_tab : 'Варианты',
named_colors : 'Варианты цвета',
color : 'Цвет (hex):',
color_name : 'Имя:'
});
