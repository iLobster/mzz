...
<table border="0" width="100%" cellpadding="0" cellspacing="1">
    ...
    {if $usersExists}
        <tr>
            <td align="center"><a href="{url section=access params="$section/$class" action=addUserDefault}" onClick="openWin('{url section=access params="$section/$class" action=addUserDefault}', 'access_adduserdefault_{$section}_{$class}', 500, 400); return false;"><img src="/templates/images/add.gif" width="16" height="16" /></a></td>
...
<table border="0" width="100%" cellpadding="0" cellspacing="1">
    ...
    {if $groupsExists}
        <tr>
            <td align="center"><a href="{url section=access params="$section/$class" action=addGroupDefault}" onClick="openWin('{url section=access params="$section/$class" action=addGroupDefault}', 'access_addgroupdefault_{$section}_{$class}', 500, 400); return false;"><img src="/templates/images/add.gif" width="16" height="16" /></a></td>
