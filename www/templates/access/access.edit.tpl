...
<table border="0" width="100%" cellpadding="0" cellspacing="1">
    {foreach from=$users item=user}
        <tr>
            ...
            <td><a href="{url section=access action=deleteUser params="$id/$user_id"}" onClick="openWin('{url section=access action=deleteUser params="$id/$user_id"}', 'access_deleteuser_{$id}_{$user_id}', 500, 400); return false;"><img src='/templates/images/delete.gif' width=16 height=16 border=0 /></a></td>
        </tr>
    {/foreach}
    {if $usersExists}
        <tr>
...
<table border="0" width="100%" cellpadding="0" cellspacing="1">
    {foreach from=$groups item=group}
        <tr>
            ...
            <td><a href="{url section=access action=deleteGroup params="$id/$group_id"}" onClick="openWin('{url section=access action=deleteGroup params="$id/$group_id"}', 'access_deletegroup_{$id}_{$group_id}', 500, 400); return false;"><img src='/templates/images/delete.gif' width=16 height=16 border=0 /></a></td>
        </tr>
    {/foreach}
    {if $groupsExists}
        <tr>
