...
<table border="0" width="99%" cellpadding="5" cellspacing="1" class="list">
    <tr>
        ...
        <td><a href="{url section=access action=editOwner params="$section/$class"}" onClick="return showJip(this.href);">Владелец объекта</a></td>
        <td>&nbsp;</td>
    </tr>
    {foreach from=$users item=user}
        <tr>
            ...
            <td><a href="{url section=access action=deleteUserDefault params="$section/$class/$user_id"}" onClick="return mzz_confirm('Вы хотите удалить этого пользователя?') && showJip(this.href);"><img src="{$SITE_PATH}/templates/images/delete.gif" width="16" height="16" /></a></td>
        </tr>
    {/foreach}
    {if $usersExists}
        <tr>
            ...
            <td colspan="2"><a href="{url section=access params="$section/$class" action=addUserDefault}" onClick="return showJip(this.href);">Добавить пользователя</a></td>
        </tr>
    {/if}
</table>
<p>Группы</p>
<table border="0" width="99%" cellpadding="0" cellspacing="1" class="list">
     {foreach from=$groups item=group}
        <tr>
            ...
            <td><a href="{url section=access action=deleteGroupDefault params="$section/$class/$group_id"}" onClick="mzz_confirm('Вы хотите удалить эту группу?') && showJip(this.href); return false;"><img src="{$SITE_PATH}/templates/images/delete.gif" width="16" height="16" /></a></td>
        </tr>
    {/foreach}
    {if $groupsExists}
        <tr>
            ...
            <td colspan=2><a href="{url section=access params="$section/$class" action=addGroupDefault}" onClick="return showJip(this.href);">Добавить группу</a></td>
        </tr>
    {/if}
</table>