        ...
        <td>
            ...
            {foreach from=$modules item=module key=id name=mcycle}
                ...
                {if $count eq 0}
                    ...
                    <a href="{url section="admin" id=$id action="deleteModule"}" onClick="mzz_confirm('Вы хотите удалить этот модуль?') &amp;&amp; showJip('{url section="admin" id=$id action="deleteModule"}'); return false;"><img src="{$SITE_PATH}/templates/images/delete.gif" alt="удалить модуль" /></a>
                {/if}
                <br />
        ...
        <td>
            ...
            {foreach from=$sections item=section key=id name=scycle}
                ...
                {if $count eq 0}
                    ...
                    <a href="{url section="admin" id=$id action="deleteSection"}" onClick="mzz_confirm('Вы хотите удалить этот раздел?') &amp;&amp; showJip('{url section="admin" id=$id action="deleteSection"}'); return false;"><img src="{$SITE_PATH}/templates/images/delete.gif" alt="удалить раздел" /></a>
                {/if}
                <br />
