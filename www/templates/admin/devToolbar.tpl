...
<table class="toolbarActions" cellpadding="1" cellspacing="0">
    {foreach from=$sections item=section key=id}
        ...
        <tr class="toolbarTitle" onmouseover="this.style.backgroundColor = '#FFFDE1'" onmouseout="this.style.backgroundColor = '#FAFAFA'">
            ...
            {/if}<a href="{url section="admin" id=$id action="addClassToSection"}"  onClick="return jipWindow.open(this.href);"><img src="{$SITE_PATH}/templates/images/classes.gif" alt="редактировать список классов" title="Редактировать список классов" align="texttop" /></a></td>
        </tr>
