...
{add file="ajax/yahoo.js"}{add file="ajax/connection.js"}{add file="common.js"}{add file="jip.js"}{add file="calendar-blue.css"}{add file="jip.css"}{add file="style.css"}
...
2007 &copy; {$smarty.const.MZZ_NAME} (v.{$smarty.const.MZZ_VERSION})</div>
