...
$router->addRoute('aclAccessDefaultsEdit', new requestRoute('access/:module_name/:user_id/:action', array('section' => 'access'), array('action' => '(?:editAccessGroup|editAccessUser)')));
