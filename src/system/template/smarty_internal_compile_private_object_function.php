...
class Smarty_Internal_Compile_Private_Object_Function extends Smarty_Internal_CompileBase
{
    ...
    public function compile($args, $compiler, $parameter, $tag, $method)
    {
        ...
        // method or property ?
        // iLobster: Smarty ignores `magic`, i just little helped him to understand miracle :)
        if (method_exists($compiler->smarty->registered_objects[$tag][0], $method) ||
            (method_exists($compiler->smarty->registered_objects[$tag][0], '__call') && !property_exists($compiler->smarty->registered_objects[$tag][0], $method))) {
