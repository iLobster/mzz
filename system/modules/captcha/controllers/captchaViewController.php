...
class captchaViewController extends simpleController
{
    public function getView()
    {
        ...
        $config = $this->toolkit->getConfig('captcha');
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            $color_text = imagecolorallocatealpha($im, mt_rand(0, 200), mt_rand(0, 200), mt_rand(0, 200), mt_rand(0, 200));
        ...
        $session->set('captcha', md5($string));
