    ...
    <div class="albumPhotos">
        <div class="albumPhotoCase">
            <div>
                ...
                <img src="{$photo->getThumbnail()}" alt="{$photo->getName()}{if $photo->getFile()}, {$photo->getFile()->getSize()|filesize}{/if}" title="{$photo->getName()}{if $photo->getFile()}, {$photo->getFile()->getSize()|filesize}{/if}" /></a>
            </div>
        </div>
    {if false}
