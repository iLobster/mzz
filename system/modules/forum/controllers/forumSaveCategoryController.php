...
/**
 * forumCreateCategoryController: контроллер дл€ метода createCategory модул€ forum
 *
 * @package modules
 * @subpackage forum
 * @version 0.1
...
class forumSaveCategoryController extends simpleController
{
    public function getView()
    {
        ...
        $validator->add('required', 'title', 'Ќеобходимо дать название категории');
        $validator->add('numeric', 'order', '«начение пор€дка сортировки должно быть числовым');
