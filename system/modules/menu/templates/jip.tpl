...
<table border="0" cellpadding="3" cellspacing="0">
    <tbody>
        <tr>
            <td><a href="#" onclick="return menu.up('item_{$id}');"><img src="{$SITE_PATH}/templates/images/arrow_up.gif" alt="up" /></a></td>
            <td><a href="#" onclick="return menu.down('item_{$id}');"><img src="{$SITE_PATH}/templates/images/arrow_down.gif" alt="down" /></td>
