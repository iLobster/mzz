...
/**
 * faqSaveController: контроллер дл€ метода create модул€ faq
 *
 * @package modules
 * @subpackage faq
 * @version 0.1
...
class faqSaveController extends simpleController
{
    public function getView()
    {
        ...
        $validator->add('required', 'question', '¬ведите все данные');
        $validator->add('required', 'answer', '¬ведите все данные');
