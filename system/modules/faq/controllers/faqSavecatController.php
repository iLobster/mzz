...
/**
 * faqSavecatController: контроллер дл€ метода createcat модул€ faq
 *
 * @package modules
 * @subpackage faq
 * @version 0.1
...
class faqSavecatController extends simpleController
{
    public function getView()
    {
        ...
        $validator->add('required', 'name', '¬ведите все данные');
        $validator->add('required', 'title', '¬ведите все данные');
