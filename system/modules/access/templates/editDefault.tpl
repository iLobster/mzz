...
<table border="0" width="99%" cellpadding="4" cellspacing="0" class="systemTable">
    <tr>
        <th colspan="3">Пользователи{if $usersExists} (<a href="{url route=withAnyParam section=access name="$class" action=addUserDefault}" class="jipLink">добавить</a>){/if}</th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="text-align: right;"><a href="{url route=withAnyParam section=access action=deleteUserDefault name="$class/$user_id"}" class="jipLink"><img src="{$SITE_PATH}/templates/images/delete.gif" width="16" height="16" /></a></td>
    </tr>
    {/foreach}

    <tr>
        <th colspan="3">Группы{if $groupsExists} (<a href="{url route=withAnyParam section=access name="$class" action=addGroupDefault}" class="jipLink">добавить</a>){/if}</th>
    </tr>
    ...
    {foreach from=$groups item=group}
        <tr>
            ...
            <td style="text-align: right;"><a href="{url route=withAnyParam section=access action=deleteGroupDefault name="$class/$group_id"}" class="jipLink"><img src="{$SITE_PATH}/templates/images/delete.gif" width="16" height="16" /></a></td>
        </tr>
    {/foreach}
</table>