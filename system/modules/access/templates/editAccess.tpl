...
<table border="0" width="99%" cellpadding="4" cellspacing="0" class="systemTable">
    ...
    {foreach from=$users item=user}
        <tr>
            ...
            <td><a href="{url route=aclAccessDefaultsEdit module=access action=editAccessUser module_name=$module.name user_id=$user->getId()}" class="mzz-jip-link">{$user->getLogin()}</a></td>
