...
{ldelim}url: "{url route="aclDefaultsAdd" section="admin" class_name=$name action="editDefault"}", ico: "key", over: "default", alt: "Редактировать права 'по умолчанию"{rdelim},
{ldelim}url: "{url route="withId" section="admin" id=$id action="listActions"}", ico: "cog", over: "edit", alt: "Редактировать действия класса"{rdelim},
