...
class new_dbTreeNS
{
    ...
    public function addSelect(criteria $criteria)
    {
        $criteria->addSelectField('tree.id', 'tree' . simpleMapper::TABLE_KEY_DELIMITER . 'id')
        ->addSelectField('tree.lkey', 'tree' . simpleMapper::TABLE_KEY_DELIMITER . 'lkey')
        ->addSelectField('tree.rkey', 'tree' . simpleMapper::TABLE_KEY_DELIMITER . 'rkey')
        ->addSelectField('tree.level', 'tree' . simpleMapper::TABLE_KEY_DELIMITER . 'level');
    }
